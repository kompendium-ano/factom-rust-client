...
pub async fn create_id_chain(
    ...
    let compose_query = compose::compose_id_chain(&client, name, pubkeys, ec_pub, false);
...
/// }
/// ```
pub async fn traverse_chain(client: &Factom, chainid: &str, depth: usize) -> Vec<Entry> {
